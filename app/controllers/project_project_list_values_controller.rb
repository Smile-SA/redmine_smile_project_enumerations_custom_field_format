...
class ProjectProjectListValuesController < ApplicationController
  ...
  def new
    ...
    @project_list_value.safe_attributes = params[:project_enumeration]
  ...
  def create
    ...
    if params[:project_enumeration]
      ...
      @project_list_value.custom_field_id = @custom_field.id
  ...
  def update
    if params[:project_enumeration]
      ...
      #@project_list_value.custom_field_id = params[:custom_field_id]
